    ...
    <div>
      ...
      <div className="pt-28">
        <div className="container relative mx-auto pb-80 bg-[#FAF8F8] rounded-3xl">
          ...
          <h3 className="text-center text-4xl mx-52 mt-32 font-Poppins">Terima Kasih sudah menjadi bagian dari Ritkola Utsa dan sudah mensupport ekosistem ekonomi kreatif MINAHASA UTARA</h3>
        </div>
      </div>
