  ...
  return (
    <div className="pt-5">
      ...
      <form className="flex flex-col">
        <input onChange={onChange} name={name} value={value} className="w-[284px] h-16 p-2 mr-4 rounded-full  text-black" type="name" required={required}  placeholder={placeholder} {...rest} />
      </form>
    </div>
  );
};
