...
function Registration() {
  return (
    <div className="w-full">
      <div>
        <img className="w-full h-[1500px] object-cover mix-blend-overlay absolute" src={imgbg2} alt="/" />
      </div>
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        <div className="px-4 py-12">
          ...
          <p className="py-4 text-1xl text-[#6F6C90] text-center sm:text-2xl">Isi data data diri dengan benar dan lengkap</p>
        </div>
      </div>
          ...
          <div className="p-4">
            ...
            <div className="col-span-2 pt-8 my-10 md:pt-2">
              ...
              <form className="flex flex-col">
                <input className="w-[284px] h-16 p-2 mr-4 rounded-full  text-black" type="name" placeholder="Type nama lengkap anda..." />
              </form>
              <span className="block font-bold mb-1 pt-5 text-black after:content-['*'] after:text-red-500 after:ml-0.5">No.WA</span>
              <form className="flex flex-col">
                <input className="w-[284px] h-16 p-2 mr-4 rounded-full  text-black" type="name" placeholder="Type nomor whatsapp anda..." />
              </form>
              ...
              <form className="flex flex-col">
                <input className="w-[284px] h-16 p-2 mr-4 rounded-full  text-black" type="name" placeholder="Type sosmed anda..." />
              </form>
